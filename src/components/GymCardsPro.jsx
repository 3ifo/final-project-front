const GymCardsPro = () => {
  return (
    <>
    <div>
      <h1 className="pro-card-h1">Consult the training <strong id="pro-card-h1-strong">plans</strong> of the month <br /> recommended by our <strong id="pro-card-h1-strong">professionals trainers.</strong></h1>
    </div>
